...
**Tests**: Core logic, provider ports/contracts, audit behavior, and boundary
rules require tests. Additional UI-only tests are included when requested by the
feature specification or implementation plan.
...
- [ ] T010 Add architecture boundary checks preventing core imports from web,
      persistence, provider SDK, and adapter layers
- [ ] T011 Add provider contract test harnesses for mock AI, broker, and
      market-data adapters
- [ ] T012 Configure Biome check tasks in the workspace quality gate
...
- [ ] T015 [P] [US1] Core unit test for domain/application behavior in
      packages/core/src/[feature].test.ts
- [ ] T016 [P] [US1] Provider contract test for mock adapter behavior in
      packages/providers-mock/src/[provider].contract.test.ts
...
- [ ] TXXX Run Biome format/check and fix reported issues
- [ ] TXXX Verify no live-trading terminology or configuration paths imply real
      brokerage execution
